...
python scripts/image_train.py --data_dir C:/Users/muril/Documents/GitHub/mlmi-oct-diffusion/data/raw/test/resized %MODEL_FLAGS% %DIFFUSION_FLAGS% %TRAIN_FLAGS% 